...
done < <(find . -path ./vendor -prune -path ./assets/styles/foundation-sites -prune -path ./dt-core/dependencies -prune -o -path ./node_modules -prune -o -path ./dependencies -prune -o -name "*.js" -print0)
